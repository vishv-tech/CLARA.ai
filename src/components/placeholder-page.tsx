...
export function PlaceholderPage({ kind }: { kind: "study" | "leaderboard" }) {
  ...
  return (
    <div className="placeholder-page">
      ...
      <h1>{isStudy ? "CLARA Study Workspace" : "CLARA Learning League"}</h1>
      <p>{isStudy ? "Chat with your academic sources, generate quizzes and learn with CLARA." : "Compete through learning consistency, not just marks."}</p>
